...
def fit_and_summarize_arima(league_game_df, metric, order=None, seasonal_order=None):
    """
...
def fit_and_forecast(league_game_df, prediction_date, metric, order=None, seasonal_order=None):
    """
...
def main(metric='league_avg_fg3a_fga', train_seasons=range(2014, 2016), test_seasons=range(2016, 2020)):
    ...
    fit_and_summarize_arima(train_league_df, metric=metric, order=(4,0,2), seasonal_order=(1, 0, 1, 206))
    ...
    for i in range(len(unique_dates) - 1):
        ...
        predictions[prediction_date] = fit_and_forecast(league_game_df, prediction_date, metric=metric, order=(4,0,2), seasonal_order=(1, 1, 1, 365))
